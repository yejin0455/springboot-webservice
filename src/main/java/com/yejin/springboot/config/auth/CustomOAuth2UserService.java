...
import com.yejin.springboot.config.auth.dto.OAuthAttributes;
import com.yejin.springboot.config.auth.dto.SessionUser;
import com.yejin.springboot.domain.user.User;
import com.yejin.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        httpSession.setAttribute("user", new SessionUser(user));  //세션에 사용자 정보를 저장하기 위한 Dto 클래스 새로 생성
